...
Stage 2 Catch2 tests consume these files. After parse, diagnostics are finalized:
source-ordered, deduplicated, and capped at `kMaxCompilationDiagnostics` (100).
